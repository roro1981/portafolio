...
class Ion_auth
{
	...
	////////////////////////////////////////////////////////////////////
	public function is_grupo($id_perfil, $permiso){
		$gruposByPerfil = $this->ion_auth_model->get_permits($id_perfil);

		foreach ($gruposByPerfil  as $row) {
				if($row == $permiso) return TRUE;
		}
