...
<!-- Modal agregar nuevo destinatario -->
					...
					<div class="row" id="rowModal">
						<div class="col-lg-12">
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-7">
								<input type="text" required class="form-control" name="phoneDeEnvio" id="phoneDeEnvio" placeholder="Ej: 56912345678">
								</div>
							</div>
...
<!-- Modal opciones de habilitacion -->
<div class="modal fade" id="manageOpciones" tabindex="-1" aria-labelledby="manageOpciones" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<form  method="post" id="form_save_opciones">
				<div class="modal-header">
					<h5 class="modal-title" id="manageOpcionesLabel"><i class="fas fa-plus"> </i>  Opciones de envio</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
       	        <div class="modal-body">
					<div class="row" id="rowModal">
						<div class="col-lg-12">
							<!-- datos destinatario -->
							<div class="my-4 text-center">
								<h4>Selecciona las opciones que deseas agregar:</h4>
							</div>

							<div class="form-group row">
								<label for="whatsapp" class="col-sm-4 offset-sm-2 col-form-label text-sm-right">
								Envío por Whatsapp:
								</label>
								<div class="col-sm-3">
								<input type="checkbox"  class="form-check-input" name="whatsapp" value="1" id="whatsapp">
								</div>
							</div>
                            <div class="form-group row">
								<label for="correo" class="col-sm-4 offset-sm-2 col-form-label text-sm-right">
								Envío por Correo:
								</label>
								<div class="col-sm-3">
								<input type="checkbox"  class="form-check-input" name="correo" value="1" id="correo">
								</div>
							</div>
                            <div class="form-group row">
								<label for="sms" class="col-sm-4 offset-sm-2 col-form-label text-sm-right">
								Envío por SMS:
								</label>
								<div class="col-sm-3">
								<input type="checkbox"  class="form-check-input" name="sms" value="1" id="sms">
								</div>
							</div>
                            <input type="text" hidden class="form-control" name="idAlertRelEmpresa" id="idAlertRelEmpresa">
						</div>
...
<script type="text/javascript">
	let idEmpresaSelected = "<?= $selectCompany ?>";
	let empresaSelected = [];
